const data = [
    ...
    },
    {
        ...
        name: "MitoSedan",
        price: "221",
        description: "Vehicle Type: Sedan, Doors: 2, Seats: 2", 
    ...
    },
    {
        ...
        name: "Isuzu Tacoma",
        price: "105",
        description: "Vehicle Type: Pickup Truck, Doors: 5, Seats: 4", 
        Luggage: "6 Suitcases / 8  Bags",
        Transmission: "Manual",
...
},
{
    _id: "6079615d0489a32f948c416a",
        ...
        price: "434",
        description:"Vehicle Type: Crossover, Doors: 5, Seats: 7" ,
        Luggage: "5Suitcases / 5Bags",
        Transmission: "Automatic",
},
];
const carShow=(data)=>{
    ...
    data.forEach(info=>{
        const{name,price,description,imageURL,Luggage}=info;
        const div=document.createElement('div');
        div.classList.add('card');
        div.innerHTML=`
        <img src="${imageURL? imageURL:"https://i.ibb.co/SJK7QYs/isuzu.png"}" class="card-img-top" alt="...">
        <div class="card-body">
